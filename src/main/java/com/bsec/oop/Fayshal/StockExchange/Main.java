...
public class Main
{
    ...
    public void manageStockListings(ActionEvent actionEvent) {
        loadFXML("/com/bsec/oop/Fayshal/StockExchange/ManageStockListings.fxml", "Manage Stock Listings", actionEvent);
    }

    // Goal 2: Publish Market Indices
    @javafx.fxml.FXML
    public void publishMarketIndices(ActionEvent actionEvent) {
        loadFXML("/com/bsec/oop/Fayshal/StockExchange/PublishMarketIndices.fxml", "Publish Market Indices", actionEvent);
    }

    // Goal 3: Handle Trading Halts
    @javafx.fxml.FXML
    public void handleTradingHalts(ActionEvent actionEvent) {
        loadFXML("/com/bsec/oop/Fayshal/StockExchange/HandleTradingHalts.fxml", "Handle Trading Halts", actionEvent);
    }

    // Goal 4: Monitor Real-time Trading Activity
    @javafx.fxml.FXML
    public void monitorTradingActivity(ActionEvent actionEvent) {
        loadFXML("/com/bsec/oop/Fayshal/StockExchange/MonitorTradingActivity.fxml", "Monitor Trading Activity", actionEvent);
    }

    // Goal 5: Publish Annual Market Reports
    @javafx.fxml.FXML
    public void publishAnnualReports(ActionEvent actionEvent) {
        loadFXML("/com/bsec/oop/Fayshal/StockExchange/PublishAnnualReports.fxml", "Publish Annual Reports", actionEvent);
    }

    // Goal 6: Manage Stock Delisting
    @javafx.fxml.FXML
    public void manageStockDelisting(ActionEvent actionEvent) {
        loadFXML("/com/bsec/oop/Fayshal/StockExchange/ManageStockDelisting.fxml", "Manage Stock Delisting", actionEvent);
    }

    // Goal 7: Co-ordinate IPO Scheduling
    @javafx.fxml.FXML
    public void coordinateIPOScheduling(ActionEvent actionEvent) {
        loadFXML("/com/bsec/oop/Fayshal/StockExchange/CoordinateIPOScheduling.fxml", "Co-ordinate IPO Scheduling", actionEvent);
    }

    // Goal 8: Investor Education Programs
    @javafx.fxml.FXML
    public void investorEducationPrograms(ActionEvent actionEvent) {
        loadFXML("/com/bsec/oop/Fayshal/StockExchange/InvestorEducationPrograms.fxml", "Investor Education Programs", actionEvent);
    }
